...
#if defined (CONFIG_OPPO_MSM_14001) || defined(CONFIG_MACH_N3)
static bool bq27541_authenticate(struct i2c_client *client)
{
	return true;
}
...
#endif //CONFIG_MACH_N3
#else //defined (CONFIG_OPPO_MSM_14001) || defined (CONFIG_MACH_N3)
...
#endif //defined (CONFIG_OPPO_MSM_14001) || defined (CONFIG_MACH_N3)
#endif //CONFIG_MACH_OPPO
