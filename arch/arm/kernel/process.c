...
#include <asm/tls.h>
#ifdef CONFIG_VENDOR_EDIT //yixue.ge@BSP.drv modify for if restart function not register and kernel crash,the system will stop by while 1
#include <mach/scm.h>
#endif
...
#ifndef CONFIG_VENDOR_EDIT //yixue.ge@BSP.drv modify for if restart function not register and kernel crash,the system will stop by while 1 
